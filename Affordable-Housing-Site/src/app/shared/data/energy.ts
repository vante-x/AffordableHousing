export class energyDB {
    static energy = [
      ...
      { 
        lat:28.582909904452688,
        lng:-81.42621397098367,
        color: [0, 204, 0,.6],//green
        energyRating:'Excellent',
        cirlceSize:30
      },
      ...
      {
        lat:28.529835949645175,
        lng: -81.38226866080994,
        color: [255, 255, 0,.6],//yellow
        energyRating:'Poor',
        cirlceSize:10
      },
      ...
      },
      {
        ...
        lng:  -81.39033674509965,
        color: [102, 0, 204,.6],//purple
        energyRating:'Good',
        cirlceSize:20
      },
      { 
        lat:28.54371013389364,
        lng:-81.3759171901989,
        color: [255, 255, 0,.6],//yellow
        energyRating:'Poor',
        cirlceSize:10
      },
      ...
      { 
        lat:28.53948774948149,
        lng:-81.39651655434284,
        color: [255, 255, 0,.6],//yellow
        energyRating:'Poor',
        cirlceSize:10
      },
      ...
      {
        lat:28.532248982483942,
        lng: -81.36141180461422,
        color: [255, 255, 0,.6],//yellow
        energyRating:'Poor',
        cirlceSize:10
      },
      ...
      { 
        lat:28.547630767871365,
        lng:-81.37840628003295,
        color: [0, 204, 0,.6],//green
        energyRating:'Excellent',
        cirlceSize:30
      },
      {
        ...
        lng: -81.35780691588901,
        color: [102, 0, 204,.6],//purple
        energyRating:'Good',
        cirlceSize:20
      },
      {
        lat:28.537527299191062,
        lng: -81.39316915766943,
        color: [255, 255, 0,.6],//yellow
        energyRating:'Poor',
        cirlceSize:10
      },
      ...
      { 
        lat:28.528176957520127,
        lng: -81.39059423715145,
        color: [102, 0, 204,.6],//purple
        energyRating:'Good',
        cirlceSize:20
      },
      { 
        lat:28.532701419990286,
        lng:-81.39952062828048,
        color: [255, 255, 0,.6],//yellow
        energyRating:'Poor',
        cirlceSize:10
      },
      ...
      //
      { 
        lat:28.55411457300274,
        lng:-81.3863027029548,
        color: [0, 0, 255,.6],//blue
        energyRating:'Superior',
        cirlceSize:40
      },
      { 
        lat:28.522294865946566,
        lng:-81.36965155027178,
        color: [0, 204, 0,.6],//green
        energyRating:'Excellent',
        cirlceSize:30
      },
      {
        lat:28.52048492558674,
        lng: -81.37497305267563,
        color: [102, 0, 204,.6],//purple
        energyRating:'Good',
        cirlceSize:20
      },
      ...
      { 
        lat:28.551400470598708,
        lng:-81.39831899870542,
        color: [0, 0, 255,.6],//blue
        energyRating:'Superior',
        cirlceSize:40
      },
      {
        lat:28.537225688216285,
        lng: -81.39522909408383,
        color: [102, 0, 204,.6],//purple
        energyRating:'Good',
        cirlceSize:20
      },
      {
        lat:28.55758249092906,
        lng: -81.36089682051062,
        color: [255, 255, 0,.6],//yellow
        energyRating:'Poor',
        cirlceSize:10
      },
      { 
        lat: 28.56255799971972,
        lng:-81.36862158206459,
        color: [255, 0, 0,.6],//red
        energyRating:'Non-Compliant',
        cirlceSize:15
      }
